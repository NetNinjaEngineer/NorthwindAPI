...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<DboCustomerDetail> DboCustomerDetails { get; set; }
    ...
    public virtual DbSet<ProductsWithCategory> ProductsWithCategories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server= .\\SQLEXPRESS; Initial Catalog= Northwind; TrustServerCertificate= True; Integrated Security= SSPI");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DboCustomerDetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("dbo.CustomerDetails");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductName, "PRODUCTS_PRODUCTNAME_IX");

            entity.HasIndex(e => new { e.ProductName, e.QuantityPerUnit }, "PRODUCTS_PRODUCTNAME_QUANTITYPERUNIT_IX");
        ...
        modelBuilder.Entity<ProductsWithCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProductsWithCategories");
